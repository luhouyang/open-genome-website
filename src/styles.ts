const styles = {
  ...
  heroHeadText: "font-black text-white lg:text-[72px] sm:text-[54px] xs:text-[30px] text-[30px] lg:leading-[98px] mt-2",
  heroSubText: "text-white-100 font-medium lg:text-[30px] sm:text-[26px] xs:text-[20px] text-[16px] lg:leading-[40px]",
  heroDescText: "text-white font-medium lg:text-[26px] sm:text-[22px] xs:text-[14px] text-[14px] lg:leading-[40px]",

  sectionHeadText: "text-white-100 font-black lg:text-[60px] md:text-[54px] sm:text-[45px] xs:text-[40px] text-[32px]",
